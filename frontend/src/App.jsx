...
function getPageMeta(pathname) {
  ...
  if (pathname === '/drawings') return { title: 'Controle de Desenhos', sub: null };
...
export default function App() {
  ...
  const btnMetaNew         = useButtonAccess('metas', 'new');
        ...
        <header className="page-header mobile-header">
          ...
          <div className="header-controls-desktop">
            <div style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
              ...
              {location.pathname === '/metas' && btnMetaNew && (
                <button onClick={() => {
